    ...
    return (
        <div className="TodoItem">
            ...
            <span className="TodoItem-right">
                ...
                {todo.status === TodoStatus.Active ?(<span className="btn">
                    <span className="TodoItem-button fas fa-check-circle"
                        onClick={handleCompletion}></span><span className="TodoItem-button fas fa-times-circle danger"
                        onClick={handleCancelation}></span></span>) : (
